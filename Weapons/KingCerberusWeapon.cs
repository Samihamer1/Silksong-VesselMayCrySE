...
namespace VesselMayCrySE.Weapons
{
    internal class KingCerberusWeapon : WeaponBase
    {
        ...
        private void CreateWeaponObjects()
        {
            ...
            devilslash.AddComponent<IceSlash>();
            ...
            devilslashalt.AddComponent<IceSlash>();
            ...
            cerberusSlashUp.AddComponent<IceSlash>();
            ...
            cerberusSlashDown.AddComponent<IceSlash>();
            ...
            GameObject? stabprefab = (GameObject?)EffectManager.Get(EffectManager.GameObjectNames.HUNTERSTAB);
            if (stabprefab != null)
            {
                GameObject cerberusDashStab = UnityEngine.Object.Instantiate(stabprefab);
                ...
                damager.nailDamageMultiplier = 1.1f;
                ...
                cerberusDashStab.AddComponent<FireSlash>();
