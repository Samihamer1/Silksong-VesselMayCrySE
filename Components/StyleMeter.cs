...
namespace VesselMayCrySE.Components
{
    public class StyleMeter : MonoBehaviour
    {
        ...
        private void AddFullStyleUI(int index)
        {
            ...
            GameObject bg = AddPartialStyleUI("VesselMayCrySE.Resources.UI.Style.Style" + index + "BG.png");
            GameObject fg = AddPartialStyleUI("VesselMayCrySE.Resources.UI.Style.Style" + index + "FG.png");
