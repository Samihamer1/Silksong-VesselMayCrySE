...
namespace VesselMayCrySE
{
    ...
    internal static class EventNames
    {
        ...
        public static readonly string HOTSTUFF = "HOTSTUFF";
        public static readonly string THUNDERCLAP = "THUNDERCLAP";
        public static readonly string ICEAGE = "ICEAGE";
    }
    ...
    internal static class AttackStyleGains
    {
        ...
        {
            [AttackNames.DRIVESLASH1] = new StyleGain(8, 3),
            [AttackNames.DRIVESLASH2] = new StyleGain(14, 3),
            [AttackNames.HIGHTIME] = new StyleGain(30, 3),
            [AttackNames.MILLIONSTAB] = new StyleGain(3.5f, 8),
            [AttackNames.MILLIONSTABRED] = new StyleGain(4, 8),
            ...
            [AttackNames.KINGSLAYER] = new StyleGain(5, 10),
            [AttackNames.HOTSTUFF] = new StyleGain(12, 3),
            [AttackNames.REVOLVER] = new StyleGain(5, 6),
            [AttackNames.THUNDERCLAP] = new StyleGain(6, 4),
            [AttackNames.SWING] = new StyleGain(14, 3)
        };
    }
