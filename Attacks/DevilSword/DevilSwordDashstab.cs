...
namespace VesselMayCrySE.Attacks.DevilSword
{
    public class DevilSwordDashstab : BaseAttack
    {
        ...
        private void RedSlash(tk2dSpriteAnimator animator, tk2dSpriteAnimationClip clip, int frame)
        {
            ...
            if (handler == null) { VesselMayCrySEPlugin.Instance.LogError("DevilCrestHandler not found. Can't create DevilSword Dashstab"); return; }
        ...
        private void CreateEffects()
        {
            ...
            if (SpecialAttacks == null) { VesselMayCrySEPlugin.Instance.LogError("Special Attacks gameobject not found. Incompatibility with other mods?"); return;  }
        ...
        public override void CreateAttack()
        {
            ...
            if (sprintfsm == null) { VesselMayCrySEPlugin.Instance.LogError("Sprint FSM not found."); return; }
            ...
            if (attackDashState == null) { VesselMayCrySEPlugin.Instance.LogError("Attack Dash state not found in SprintFSM. Incompatibility with other mod?"); return; }
